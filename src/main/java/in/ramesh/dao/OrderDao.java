...
public class OrderDao {
	...
	public static List<Order> findAllFood() throws DBException{
		...
		try {
			...
			while (rs.next()) {
				...
				Order food = new Order(foodName, price, foodType,hotelName);
				foodList.add(food);
			}
	...
	public void save(Order food) throws DBException{
